...
namespace Zoo
{
    ...
    {
        public ElephantAnimals(string species, string biome, double squareM2, string food, string predatorOrHerbivore, string sound, string name, double needFoodVolume, int age)
        {
            Species = species;
            Biome = biome;
            SquareM2 = squareM2;
        ...
        {
            Console.WriteLine($"{Name} умеет трубить хоботом");
        }
